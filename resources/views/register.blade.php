    ...
    <div class="w-screen h-screen bg-[url(/public/assets/background.png)] flex justify-center items-center">
        ...
        <div class="absolute top-[80px] left-[80px] cursor-pointer">
            ...
            <div class="flex flex-col gap-5">
                ...
                <form action="" class="pb-[1rem]">
                <a href="/login" class="rounded-sm bg-[#1868DB] hover:bg-[#2518db] duration-[0.1s] w-[25vw] h-[6vh] focus:outline-2 focus:outline-offset-2 focus:outline-[#1868DB] cursor-pointer text-[#fff] flex items-center justify-center">
    Continue
</a>
                </form>
